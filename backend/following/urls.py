...
urlpatterns = [
    ...
    re_path(r'^get_following_users/(?P<username>[\w\s]+)?/$', views.GetFollowing.as_view(), name="get following"),
    re_path(r'^get_followers_users/(?P<username>[\w\s]+)?/$', views.GetFollowers.as_view(), name="get followers"),
]