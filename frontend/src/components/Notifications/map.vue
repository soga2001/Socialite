...
<template>
    <div class="relative">
        <Item class="max-w-viewport w-full pointer item" clickable :to="notification.data?.url"  align-items="start"  avatarSize="3.5rem">
            <template #avatar>
                ...
                <Item dense align-items="start">
                    ...
                    <template #title>
                        <div class="h-full min-w-full flex gap-1 items-center title">
                            ...
                            <span class="h-full" v-if="notification.actor.verified">
        ...
        <span v-if="unread" class="unread px-5 weight-900 text-white">
            Unread
        </span>
    </div>
